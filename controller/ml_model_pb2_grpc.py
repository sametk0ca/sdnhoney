...
import ml_model_pb2 as ml__model__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in ml_model_pb2_grpc.py depends on'
...
class MLModelServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PredictPacket = channel.unary_unary(
                ...
                response_deserializer=ml__model__pb2.Prediction.FromString,
...
def add_MLModelServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PredictPacket': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=ml__model__pb2.Prediction.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'ml_model.MLModelService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ml_model.MLModelService', rpc_method_handlers)
...
class MLModelService(object):
    ...
    def PredictPacket(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            ml__model__pb2.Prediction.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
